...
public class Lambda02 {
    ...
    public static void printElFunctional2(List<Integer> sayi) {
        sayi.stream().forEach(Lambda02::yazdir);//method reference--> System.out yapısında prin methodu refere et
    }
    ...
    public static void printCiftElFunctional1(List<Integer> sayi) {
        ...
        sayi.
                ...
                filter(Lambda02::ciftBul).//cift bul method refere edilerek akısdaki elemalar filtrelendi(cift sayı)
                forEach(Lambda02::yazdir);//fitre den gelen elemanlar yazdır() method refer edilerek print edildi
    ...
    public static void printCiftOtzKckFunctional(List<Integer> sayi) {
        sayi.
                stream().
                // filter(t -> t % 2 == 0 && t < 34).
                        filter(Lambda02::ciftBul).//method ref.
